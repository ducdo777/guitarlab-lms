    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8">
        ...
        {selectedSession ? (
          ...
          /* -------------------------------------------------------------
              VIEW 2: KẾT QUẢ BÀI NỘP & NHẬN XÉT TỪ GIẢNG VIÊN
             ------------------------------------------------------------- */
          <div className="space-y-8 animate-fadeIn">
            ...
            {mySubmissions.length === 0 ? (
              <div className="bg-white p-12 sm:p-16 rounded-3xl border border-slate-200/80 text-center space-y-4 shadow-xs">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[#1b2a47] hover:bg-slate-800 text-white font-extrabold rounded-2xl transition-all text-xs inline-flex items-center gap-2 shadow-md"
                >
              ...
              <div className="space-y-6">
                {mySubmissions.map((sub: any) => {
                  ...
                  return (
                    <div key={sub.id} className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-6">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-bold px-3 py-1 rounded-full bg-amber-50 text-amber-800 border border-amber-200">
                              Buổi {sub.session_id} / 8
                            </span>
                            <h3 className="font-black text-lg text-[#1b2a47]">
                              {sessInfo?.title || `Buổi học ${sub.session_id}`}
                            </h3>
                          </div>
                        ...
                        <div className="flex items-center gap-3">
                          {isReviewed ? (
                            <div className="flex items-center gap-2 bg-emerald-50 text-emerald-800 px-4 py-2 rounded-2xl border border-emerald-200 shadow-xs">
                              <span className="text-base font-black text-emerald-700">⭐ {sub.grade}/10 Điểm</span>
                      ...
                      {sub.video_url && (
                        <div className="space-y-2">
                          ...
                          <div className="aspect-video w-full max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-lg bg-black">
                      ...
                      <div className="pt-2 flex justify-end">
                        ...
                        >
                          Vào Học Lại Buổi {sub.session_id} ➔
                        </button>
                      </div>
